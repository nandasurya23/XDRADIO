...
const HeroSection = () => {
  return (
    <div className="w-full pb-10 bg-gradient-to-br from-prime-1 to-prime-2 font-Poppins text-center text-white">
      ...
      <div className="flex mx-auto items-center w-11/12 px-3 mt-5">
        <div className="px-3">
          <img
        ...
        <div className="flex flex-col mx-8 font-Poppins">
          ...
          <div className="flex justify-start items-center">
            <button className="mt-10 px-5 py-4 rounded-xl bg-gradient-to-b from-yellow-1 to-yellow-2 text-dark font-semibold w-1/3 text-xl tracking-wider">
              Info Selengkapnya
            </button>
          </div>
        </div>
